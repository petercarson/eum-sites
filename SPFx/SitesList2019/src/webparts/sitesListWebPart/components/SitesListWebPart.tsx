...
import { sp, SearchResults } from "@pnp/sp/presets/all";
  ...
  private RenderSitesList() {
    ...
    return (
      <Pivot aria-label={this.props.webpartTitle}>
        ...
        {currentUserSitesDisplay ? <PivotItem linkText={this.props.tabHeaderUserSites}>
          {currentUserSitesDisplay}
        </PivotItem> : ""}

        {availableSitesDisplay ? <PivotItem linkText={this.props.tabHeaderAvailableSites}>
          {availableSitesDisplay}
        </PivotItem> : ""}

        {allSitesDisplay ? <PivotItem linkText={this.props.tabHeaderAllSites}>
          {allSitesDisplay}
        </PivotItem> : ""}
      </Pivot>
    );
      ...
      <Fabric>
        <Pivot>
          {groupedSites.map((groupedSite) => {
            return (
              <PivotItem linkText={groupedSite.index}>
